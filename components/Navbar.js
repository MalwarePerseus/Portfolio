            ...
            <div className="flex md:flex-row justify-between items-center">
                ...
                <div className="">
                    ...
                    <Link href="/achievements">
                        <a 
                            className={`text-base  ${router.asPath === "/achievements"? "text-gray-800 font-bold dark:text-gray-400": "text-gray-600 dark:text-gray-300 font-normal "
                            }`}
                        >   
                            Achievements
                            {router.asPath === "/achievements" && (
                                <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
